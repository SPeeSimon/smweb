    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-horizontal">
              ...
              <div class="input-group">
                <span class="input-group-addon" style="width: 8em">Description</span>
                <input
                  type="text"
                  class="form-control"
              ...
              <div class="input-group">
                <span class="input-group-addon" style="width: 8em">Type</span>
                <input type="text" class="form-control" placeholder="fixme" :value="model.type" :readonly="cantWrite" />
              </div>
              <div class="input-group">
                <span class="input-group-addon" style="width: 8em">Author</span>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <h5>Model Position(s) <span v-text="positions.length"></span></h5>
      ...
      <div class="panel-footer"><span>The last update of this model was </span><span v-text="model.modified"></span></div>
